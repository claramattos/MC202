...
class Task(BaseTask):
    def teste_1_mini(self):
        binary = self.compile(binary="equipes")
        self.test_cases(binary, ["teste3.in", "teste8.in"])

    def teste_2_pequeno(self):
        binary = self.compile(binary="equipes")
        self.test_cases(binary, ["teste6.in", "teste7.in", "teste4.in"])

    def teste_3_medio(self):
        binary = self.compile(binary="equipes")
        self.test_cases(binary, ["teste2.in", "teste1.in", "teste9.in"])

    def teste_4_grande(self):
        binary = self.compile(binary="equipes")
        self.test_cases(binary, ["teste5.in", "teste10.in"])
