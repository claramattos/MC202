...
class Task(BaseTask):
    def teste_1_ordenado(self):
        binary = self.compile(["classificar.c"])
        self.test_cases(binary, self.case_range("homonimos{}.in", 1, 4))

    def teste_2_desordenado(self):
        binary = self.compile(["classificar.c"])
        self.test_cases(binary, self.case_range("homonimos{}.in", 5, 8))

    def teste_3_parentes(self):
        binary = self.compile(["classificar.c"])
        self.test_cases(binary, self.case_range("parentes{}.in", 9, 12))
