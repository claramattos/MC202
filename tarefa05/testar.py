...
class Task(BaseTask):
    def teste_1_quant_base_pequena(self):
        binary = self.compile(["ribossomo.c"])
        self.test_cases(binary, self.case_range("dna{}.in", 1, 3))

    def teste_2_quant_base_media(self):
        binary = self.compile(["ribossomo.c"])
        self.test_cases(binary, self.case_range("dna{}.in", 4, 6))

    def teste_3_quant_base_grande(self):
        binary = self.compile(["ribossomo.c"])
        self.test_cases(binary, self.case_range("dna{}.in", 7, 8))
