...
class Task(BaseTask):
    def teste_1_busca_simples(self):
        binary = self.compile(binary="busca")
        self.test_cases(binary, ["teste1.in", "teste2.in"])

    def teste_2_busca_multipla(self):
        binary = self.compile(binary="busca")
        self.test_cases(binary, ["teste3.in", "teste4.in","teste5.in"])

    def teste_3_busca_multipla_complexa(self):
        binary = self.compile(binary="busca")
        self.test_cases(binary, ["teste6.in", "teste7.in"])
