...
class Task(BaseTask):
    def teste_1_simples(self):
        binary = self.compile(["minecraft.c"])
        self.test_cases(binary, self.case_range("teste_simples_{}.in", 1, 3))

    def teste_2_mapa_pequeno(self):
        binary = self.compile(["minecraft.c"])
        self.test_cases(binary, self.case_range("mapa_pequeno_{}.in", 1, 3))

    def teste_3_mapa_medio(self):
        binary = self.compile(["minecraft.c"])
        self.test_cases(binary, self.case_range("mapa_medio_{}.in", 1, 3))

    def teste_4_mapa_grande(self):
        binary = self.compile(["minecraft.c"])
        self.test_cases(binary, self.case_range("mapa_grande_{}.in", 1, 3))
