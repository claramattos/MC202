...
class Task(BaseTask):
    def teste_1_pequeno(self):
        binary = self.compile(binary="def_capitais")
        self.test_cases(binary, self.case_range("piaui{}.in", 1, 3))
        self.test_cases(binary, self.case_range("pequeno{}.in", 1, 2))

    def teste_2_medio(self):
        binary = self.compile(binary="def_capitais")
        self.test_cases(binary, self.case_range("bahia{}.in", 4, 6))
        self.test_cases(binary, self.case_range("medio{}.in", 1, 2))

    def teste_3_grande(self):
        binary = self.compile(binary="def_capitais")
        self.test_cases(binary, self.case_range("saopaulo{}.in", 7, 9))
        self.test_cases(binary, self.case_range("grande{}.in", 1, 1))
