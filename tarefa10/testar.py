...
class Task(BaseTask):
    def teste_1_pequeno(self):
        binary = self.compile(binary="docas")
        self.test_cases(binary, ["teste1.in", "teste2.in", "teste3.in"])

    def teste_2_medio(self):
        binary = self.compile(binary="docas")
        self.test_cases(binary, ["teste4.in", "teste5.in", "teste6.in"])

    def teste_3_variacao(self):
        binary = self.compile(binary="docas")
        self.test_cases(binary, ["teste7.in", "teste8.in", "teste9.in"])

    def teste_4_fila_nao_extinta(self):
        binary = self.compile(binary="docas")
        self.test_cases(binary, ["teste10.in", "teste11.in", "teste12.in"])
