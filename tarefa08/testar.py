...
class Task(BaseTask):
    def teste_0_lanterna(self):
        binary = self.compile(binary="boate")
        self.test_cases(binary, self.case_range("teste{}.in", 1, 2))

    def teste_1_inicio(self):
        binary = self.compile(binary="boate")
        self.test_cases(binary, self.case_range("teste{}.in", 3, 4))

    def teste_2_final(self):
        binary = self.compile(binary="boate")
        self.test_cases(binary, self.case_range("teste{}.in", 5, 7))

    def teste_3_fiscal(self):
        binary = self.compile(binary="boate")
