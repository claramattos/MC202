...
class Task(BaseTask):
    def teste_1_quant_esquema_pequena(self):
        binary = self.compile(binary="piramide")
        self.test_cases(binary, self.case_range("esquema{}.in", 1, 3))

    def teste_2_quant_esquema_media(self):
        binary = self.compile(binary="piramide")
        self.test_cases(binary, self.case_range("esquema{}.in", 4, 6))

    def teste_3_quant_esquema_grande(self):
        binary = self.compile(binary="piramide")
        self.test_cases(binary, self.case_range("esquema{}.in", 7, 8))
